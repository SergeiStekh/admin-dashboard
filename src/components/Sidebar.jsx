    ...
    return (
        <div
            ...
            <div className='flex justify-between items-center'>
                <Link to="/" onClick={() => setIsMenuActive(prev => !prev)} className="items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900">
                  <ShopIcon/>
